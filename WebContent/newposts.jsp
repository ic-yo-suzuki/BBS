			...
			<table class="newpost">
				<form action="newpost" method="post">
					<tr>
						...
						</select><br> <input name="newCategory" id="newCategory"
							value="${inputValues.category }">(新たに追加するカテゴリ名を10文字以内で入力してください)
						</td>
					</tr>
					<tr>
						<td>投稿者</td>
					...
					<tr>
						...
						<td><input name="title" id="title"
							value="${inputValues.title }"></td>
					</tr>
					<tr>
						<td>本文(1000文字まで)</td>
						<td><textarea name="message" cols="80" rows="10"
								class="post-box"><c:out value="${inputValues.text }"></c:out></textarea>
						</td>
					</tr>
